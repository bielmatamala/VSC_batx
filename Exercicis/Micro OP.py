"""  print(f"Descarregat {user_input_descareges}")
                ...
                if resposta == "si":
                    ...
                    canvi = input(
                        "A quines unitats vols canviar (km/h o km/s)?: ")
                    ...
                    if canvi == "km/h":
                        ...
                        nombre = input("Introdueix el valor en km/s: ")
                        resultatkms = float(nombre) * 1000
                        print(f"{resultatkms} m/s")
