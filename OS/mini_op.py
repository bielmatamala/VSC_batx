...
def MRUA_arrondonir(
    opcio, resultat, resultat2, resultat3, resultat4, resultat5, arrodonir
):
...
def Config(users, current_user):
    ...
    if current_user == "admin":
        ...
        if user_input_configuracio == "afegir usuari":
            ...
            usuari_a_treure = input(
                "Introdueix el nom de l'usuari que vols treure: "
            ).strip()
            ...
            usuari_a_editar = input(
                "Introdueix el nom de l'usuari que vols editar: "
            ).strip()
        ...
        while True:
            ...
            if user_input_menu in MENU:
                ...
                if user_input_menu == "descareges":
                    user_input_username = show_descareges(
                        DESCAREGES, user_input_username
                    )
